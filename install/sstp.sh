...
git clone https://github.com/why-vpn/accel-ppp.git /opt/accel-ppp-code
...
#
GitUser="why-vpn"
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/${GitUser}/bangke/main/modul/accel.conf"
...
cd
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
