...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/cekwg.sh"
wget -O xpwg "https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/${GitUser}/bangke/main/menu/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xpwg
